...
public class EnhancementTableMenu extends AbstractContainerMenu {
    public final EnhancementTableBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public EnhancementTableMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(3));
    }

    public EnhancementTableMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.ENHANCEMENT_TABLE_MENU.get(), id);
        checkContainerSize(inv, 3);
        blockEntity = (EnhancementTableBlockEntity) entity;
    ...
    public EnhancementTableBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.ENHANCEMENT_TABLE.get());
    }
